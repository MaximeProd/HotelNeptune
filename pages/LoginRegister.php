    ...
    <p>'.$erreur.'</p>
      <div class="LoginRegister">
        ...
        <form class="Register" action="loginRegister/Register.php" method="post">
          ...
          <input value="'.$savePostRegister["mdp"].'"        type="password" name="mdp"          placeholder="Mot de passe"            maxlength="16"     minlength="6"    required="required">
          <input value="'.$savePostRegister["confirmMdp"].'" type="password" name="confirmMdp"   placeholder="Confirmer mot de passe"  maxlength="16"     minlength="6"    required="required">
